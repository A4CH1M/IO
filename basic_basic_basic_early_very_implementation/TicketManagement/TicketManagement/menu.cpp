...
void clientMenu(std::vector<std::shared_ptr<Client>>&);
void ticketMenu(std::vector<std::shared_ptr<Client>>&, std::vector<std::shared_ptr<Employee>>&);
void clientStatsMenu(std::vector<std::shared_ptr<Client>>&);
void employeeMenu(std::vector<std::shared_ptr<Employee>>&);
void menu() {
...
void ticketMenu(std::vector<std::shared_ptr<Client>>& clients, std::vector<std::shared_ptr<Employee>>& employees) {
	system("cls");
	size_t choice;
	bool _exit = false;
	do {
...
void clientStatsMenu(std::vector<std::shared_ptr<Client>>& clients) {
	system("cls");
	size_t choice;
	bool _exit = false;
	do {
...
void employeeMenu(std::vector<std::shared_ptr<Employee>>& employees) {
	system("cls");
	size_t choice;
	bool _exit = false;
	do {
