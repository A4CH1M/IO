...
ServiceTechnician::ServiceTechnician(std::string pesel, std::string name, std::string surname, std::string dateOfEmployment, size_t previousWorkPeriod)
	: Employee(pesel, name, surname, dateOfEmployment, previousWorkPeriod) {
	setEmployeePosition("Technik serwisant");
	setEmployeeSalary(4000);
}
ServiceTechnician::~ServiceTechnician() {}
